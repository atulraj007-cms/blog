...
?>
                     ...
                     <div class='huge'><?php echo $count_comment_rows = CommentCountPosts(); ?></div>
                      <div>Comments</div>
                    </div>
                </div>
            </div>
...
?>                   
                        <div class='huge'><?php echo $count_category_rows = CategoryCountUsers(); ?></div>
                         <div>Categories</div>
                    </div>
                </div>
            </div>
...
// $count_draft_rows = mysqli_num_rows($draft_query);
 $count_draft_rows = dashboardCountDraftMyData();

// $query = "SELECT * FROM comments WHERE comment_status = 'approved' ";
// $comment_query = mysqli_query($connection,$query);
 $count_approved_rows = dashboardCountCommentApprovedtMyData();
// $query = "SELECT * FROM users WHERE user_role = 'admin' ";
// $admin_query = mysqli_query($connection,$query);
 $count_admin_rows = dashboardCountAdminMyData();


// $query = "SELECT * FROM users WHERE user_role = 'subscriber' ";
// $subscriber_query = mysqli_query($connection,$query);
$count_subscriber_rows = dashboardCountSubscriberMyData();
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Data', 'Count'],
            ...
            $element_text = ['Active Posts', 'Comments', 'Category','Admin Users','Subscribers'];
            $element_count = [$count_post_rows, $count_comment_rows, $count_category_rows,  $count_admin_rows, $count_subscriber_rows];
